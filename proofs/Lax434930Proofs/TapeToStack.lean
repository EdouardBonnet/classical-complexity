...
namespace Lax434930Proofs.TapeToStack

open Turing Time Lax434930.MachineModels
...
theorem singleTapeP_subset_P : SingleTapeP ⊆ Lax434930.PolynomialTime.P := by
  classical
  rintro L ⟨M, p, hM⟩
...
end Lax434930Proofs.TapeToStack
