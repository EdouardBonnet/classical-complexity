...
namespace Lax434930Proofs.StackToTape

open Turing Time TM2to1 Lax434930.MachineModels
...
theorem P_subset_singleTapeP : Lax434930.PolynomialTime.P ⊆ SingleTapeP := by
  rw [← FiniteAlphabet.finiteStackP_eq_P]
  exact finiteStackP_subset_singleTapeP

end Lax434930Proofs.StackToTape
