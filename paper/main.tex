...
$\mathrm P\subseteq\mathrm{NP}$, and $\mathrm{PSPACE}\subseteq\mathrm{NPSPACE}$,
...
\]
The formal proofs currently cover the three statements below.
The other three arrows, $\mathrm{NL}\subseteq\mathrm P$,
$\mathrm{NP}\subseteq\mathrm{PSPACE}$, and
$\mathrm{NPSPACE}\subseteq\mathrm{EXPTIME}$, remain formal proof obligations.
