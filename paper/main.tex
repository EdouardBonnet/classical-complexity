...
\]
The formal proofs currently cover the five statements below.
The arrow $\mathrm{NL}\subseteq\mathrm P$ remains a formal proof obligation.
No completed proof assumes this obligation.
...
\begin{lemma}\leavevmode
% lax begin Lax434930.BasicProperties.NP_subset_PSPACE
$\mathrm{NP}\subseteq\mathrm{PSPACE}$.
% lax end Lax434930.BasicProperties.NP_subset_PSPACE
\end{lemma}
...
$\mathrm{NPSPACE}$; the proved equality
$\mathrm{PSPACE}=\mathrm{NPSPACE}$ gives the conclusion.
\qedhere
% lax end Lax434930Proofs.NP_subset_PSPACE
\end{proof}

\begin{lemma}\leavevmode
% lax begin Lax434930.PolynomialSpaceEquality.PSPACE_eq_NPSPACE
$\mathrm{PSPACE}=\mathrm{NPSPACE}$.
% lax end Lax434930.PolynomialSpaceEquality.PSPACE_eq_NPSPACE
\end{lemma}
