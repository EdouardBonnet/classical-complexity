...
characterizations are included locally. We prove $\mathrm L\subseteq\mathrm{NL}$,
$\mathrm P\subseteq\mathrm{NP}$, and $\mathrm{PSPACE}\subseteq\mathrm{NPSPACE}\subseteq\mathrm{EXPTIME}$,
as well as the stated encoding properties and closure of $\mathrm P$ under
complement. The formalization uses Lean and Mathlib 4.33.0.
\end{abstract}
...
% lax begin Lax434930.Certificates.unpair_pair
Decoding $\langle x,y\rangle$ returns exactly $(x,y)$.
% lax end Lax434930.Certificates.unpair_pair
\end{lemma}
...
\begin{lemma}\leavevmode
% lax begin Lax434930.Certificates.pair_injective
The function $(x,y)\mapsto\langle x,y\rangle$ is injective.
% lax end Lax434930.Certificates.pair_injective
\end{lemma}
...
\begin{lemma}\leavevmode
% lax begin Lax434930.Certificates.pair_length
The encoded pair has length $|\langle x,y\rangle|=2|x|+|y|+1$.
% lax end Lax434930.Certificates.pair_length
\end{lemma}
...
\begin{proof}\leavevmode
% lax begin Lax434930Proofs.ComplementClosure.closed_under_complement
...
\qedhere
% lax end Lax434930Proofs.ComplementClosure.closed_under_complement
\end{proof}
...
\]
The formal proofs currently cover the four statements below.
The other two arrows, $\mathrm{NL}\subseteq\mathrm P$ and
$\mathrm{NP}\subseteq\mathrm{PSPACE}$, remain formal proof obligations.
No completed proof assumes these obligations.

\begin{lemma}\leavevmode
% lax begin Lax434930.BasicProperties.L_subset_NL
$\mathrm L\subseteq\mathrm{NL}$.
% lax end Lax434930.BasicProperties.L_subset_NL
\end{lemma}
...
% lax begin Lax434930.BasicProperties.P_subset_NP
$\mathrm P\subseteq\mathrm{NP}$.
% lax end Lax434930.BasicProperties.P_subset_NP
\end{theorem}
...
\begin{lemma}\leavevmode
% lax begin Lax434930.BasicProperties.PSPACE_subset_NPSPACE
$\mathrm{PSPACE}\subseteq\mathrm{NPSPACE}$.
% lax end Lax434930.BasicProperties.PSPACE_subset_NPSPACE
\end{lemma}

\begin{proof}\leavevmode
% lax begin Lax434930Proofs.BasicProperties.PSPACE_subset_NPSPACE
Use the same machine and polynomial space bound, and remove the determinism requirement.
\qedhere
% lax end Lax434930Proofs.BasicProperties.PSPACE_subset_NPSPACE
\end{proof}

\begin{lemma}\leavevmode
% lax begin Lax434930.BasicProperties.NPSPACE_subset_EXPTIME
$\mathrm{NPSPACE}\subseteq\mathrm{EXPTIME}$.
% lax end Lax434930.BasicProperties.NPSPACE_subset_EXPTIME
\end{lemma}
